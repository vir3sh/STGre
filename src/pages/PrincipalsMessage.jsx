            ...
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
              ...
              <div className="space-y-6 text-justify">
                <p>
                  ...
                  questions you may have about our school, our academic
                  programmes, the extra-curricular activities and life as a
                  member of the Gregorian family
                </p>

                <p>
                  We, at Gregorios, are dedicated to maintaining an exceptional
                  educational environment. Our engaging teaching methodologies
                  adhere to the highest standard and encourage success in
                  concept-based learning and developing competencies. The entire
                  world has witnessed an era of intense transformation in all
                  areas, whether it is education, global trade and economy,
                ...
                <p>
                  ...
                  opportunities for academic and personal growth both inside and
                  outside the classrooms, St. Gregorios High School could be the
                  place for you. Tomorrow’s jobs may not exist yet
                </p>

                <p>
                  However, through exposure to collaborative problem solving,
                  creativity, oral and written communication, critical thinking,
                  ethical decision making and leadership, our skills-based
                  21st-century curriculum would go a long way in preparing our
                  students to face the future with confidence and equanimity.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#541418] rounded-2xl shadow-xl p-8 md:p-12 text-white">
            ...
            <div className="max-w-4xl mx-auto text-center">
              <p className="text-xl mb-6 text-blue-100">
                The St. Gregorios Education & Medical Trust was formed in 1992,
                with the express purpose of giving back to the community in
                which they were based, something special - and what could be
                more special than young people, enlightened and eager to do
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-sm text-gray-600">
                Affiliated to Council for Indian School Certificate Examinations
              </p>
            </div>
